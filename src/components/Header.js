          ...
          <div className="nav-content">
            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
              ...
              <ul className="mb-1 top-content">
                ...
                <li>
                  <Link to="/skills" className="nav-content-bttn open-font">
                    <i className="feather-award btn-round-md bg-red-gradiant me-3"></i>
                    <span>Skills</span>
                  </Link>
                </li>
                <li>
                  <Link to="/jobs/list" className="nav-content-bttn open-font">
                    <i className="feather-briefcase btn-round-md bg-gold-gradiant me-3"></i>
                    <span>Jobs</span>
                  </Link>
                </li>
                <li>
                  <Link to="/shop" className="nav-content-bttn open-font">
                    <i className="feather-shopping-cart btn-round-md bg-mini-gradiant me-3"></i>
                    <span>Shop</span>
                  </Link>
                </li>
                <li>
              ...
              <ul className="mb-3">
                <li>
                  <Link
                    ...
                    className="nav-content-bttn open-font"
                  >
                    <i className="font-xl text-current feather-award me-3"></i>
                    <span>Skills</span>
                  </Link>
                </li>
                <li>
                  <Link
                    to="/admin/skills/questions"
                    className="nav-content-bttn open-font"
                  >

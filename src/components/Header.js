                        ...
                        <div className="nav-content">
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                                ...
                                <ul className="mb-1 top-content">
                                    ...
                                    <li><Link to="/event" className="nav-content-bttn open-font"><i className="feather-tv btn-round-md bg-blue-gradiant me-3"></i><span>Events</span></Link></li>
                            ...
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                                ...
                                <ul className="mb-3">
                                    ...
                                    <li><Link to="/admin/skills" className="nav-content-bttn open-font"><i className="font-xl text-current feather-home me-3"></i><span>Skills</span></Link></li>
                                    <li><Link to="/admin/skills/questions" className="nav-content-bttn open-font"><i className="font-xl text-current feather-map-pin me-3"></i><span>Questions</span></Link></li>

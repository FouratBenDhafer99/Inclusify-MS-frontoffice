...
function CreatePostModal({ visible, onClose, user, projectId }) {
  ...
  const handleCreatePost = async (e) => {
    ...
    let data = await feedApi.createPost(formData);
                ...
                <ul className="list">
                  <li>
                    <label htmlFor="image-input">
                      <img
                        src="/assets/newsfeedAssets/icons/gallery.svg"
                        alt="gallery"
                      />
                    </label>
                    <input
                  ...
                  <li>
                    <img
                      src="/assets/newsfeedAssets/icons/tag.svg"
                      alt="gallery"
                    />
                  </li>
                  <li>
                    <img
                      src="/assets/newsfeedAssets/icons/emoji.svg"
                      alt="gallery"
                    />
                  </li>
                  <li>
                    <img
                      src="/assets/newsfeedAssets/icons/mic.svg"
                      alt="gallery"
                    />
                  </li>
                  <li>
                    <img
                      src="/assets/newsfeedAssets/icons/more.svg"
                      alt="gallery"
                    />
                  </li>
                </ul>
          ...
          <section className={"audience"}>
            ...
            <ul className="list">
              ...
              <li>
                <div className="column">
                  <div className="icon">
                    <i className="fas fa-light fa-angry" />
                  </div>
                  <div className="details">
                    <p>Complaint</p>

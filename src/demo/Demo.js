              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-5 mt-5 mb-5">
                    ...
                    <p>
                      With beautifully designed custom post types to show off
                      your works and collections.Sociala powers thousands of
                      apps at some of the smartest companies around the world.
                      Be a part of professional community
                    </p>
                    <a
                      href="/"
                      className="btn btn-lg btn-primary mr-4 text-uppercase mt-4"

...
const Job =()=> {
    ...
    useEffect(() => {
        axios.get('http://localhost:8092/job/all')
        .then((response) => {
  ...
  const [query, setQuery] = useState("");
    ...
    const search = () => {
        ...
        // Update the job list in the parent component
                        ...
                        <div className="middle-sidebar-left pe-0" style={{maxWidth: "100%"}}>
                            <div className="row">
                                <div className="col-xl-6 chat-left scroll-bar">
                                    <Pagetitle setQuery={setQuery} search={search} title="Jobs" />
                                    ...
                                    <div key={index} className="card d-block w-100 border-0 mb-3 shadow-xss bg-white rounded-3 pe-4 pt-4 pb-4"  style={{paddingLeft: "120px"}}>
                                        <img src={`assets/images/download5.png`} alt="job-avatar" className="position-absolute p-2 bg-lightblue2 w65 ms-4 left-0" />
